...
import { updateDiklat } from '@/actions/dashboard-action';
...
export default function EditDiklatView({ user, diklat }: { user: any; diklat: DiklatData }) {
    ...
    const [formData, setFormData] = useState({
        ...
        metode: diklat.metode,
        target: diklat.target || '',
        tanggalMulai: formatDateForInput(diklat.tanggalMulai),
        tanggalSelesai: formatDateForInput(diklat.tanggalSelesai),
        waktuMulai: diklat.waktuMulai || '08:00',
        waktuSelesai: diklat.waktuSelesai || '16:00',
        batasPendaftaran: formatDateForInput(diklat.batasPendaftaran),
        kuota: diklat.kuota,
        lokasi: diklat.lokasi || '',
        linkMeeting: diklat.linkMeeting || '',
        materi: diklat.materi.length > 0 ? diklat.materi : [''],
        persyaratan: diklat.persyaratan.length > 0 ? diklat.persyaratan : [''],
        fasilitas: diklat.fasilitas.length > 0 ? diklat.fasilitas : [''],
        isActive: diklat.isActive
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            const result = await updateDiklat(diklat.id, {
                nama: formData.nama,
            ...
            <div className="max-w-4xl mx-auto p-4 lg:p-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
                        ...
                        <span>/</span>
                        <span className="text-gray-900">Edit Diklat</span>
                    </div>
                    <h1 className="text-2xl lg:text-3xl font-bold">Edit Diklat</h1>
                    <p className="text-gray-500 mt-1">Ubah informasi diklat: {diklat.nama}</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Card className="border-0 shadow-md mb-6">
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <h3 className="font-medium">Status Diklat</h3>
                                    <p className="text-sm text-gray-500">Aktifkan atau nonaktifkan diklat ini</p>
                                </div>
                                <button
                                    type="button"
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-between">
                        ...
                        >
                            {isPending ? 'Menyimpan...' : <><BiSave /> Simpan Perubahan</>}
                        </Button>
                    </div>
                </form>
            </div>
